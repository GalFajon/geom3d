...
export class Cursor {
    ...
    static material = new THREE.SpriteMaterial({ map: Cursor.generateSpriteTexture('white'), depthTest: false, depthWrite: false, transparent: true });
    ...
    updateHeight(e) {
        ...
        for (let source of view.layers) {
            if ((source.type == "PointcloudLayer" || source.type == "GeometryLayer") && source.Models) {
